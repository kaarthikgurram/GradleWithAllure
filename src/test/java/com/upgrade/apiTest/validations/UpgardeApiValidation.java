...
public class UpgardeApiValidation {
  ...
  public void validateApprovedApiResponse(Response response) throws JSONException {
    ...
    Assert.assertEquals(
        "34c16f53-38c4-461a-bd14-11fa748d2663", jsonObject.getString("userUuid"));
    ...
    Assert.assertEquals("230ea84a-7199-41c9-bf38-fff27e35970d", loansInReview.getJSONObject(0).getString("uuid"));
    ...
    Assert.assertEquals("2019-08-21T18:18:59.959Z", loansInReview.getJSONObject(0).getString("createDate"));
    ...
    Assert.assertEquals(
        "null",
        loanAccountSummaryAto.getJSONObject(0).getString("postIssuanceLoanStatus"));
    Assert.assertEquals("0", loanAccountSummaryAto.getJSONObject(0).getString("daysPastDue"));
    Assert.assertEquals("null", loanAccountSummaryAto.getJSONObject(0).getString("loanProductType"));
  ...
  public void validateErrorResponse(Response response) {
    ...
    Assert.assertEquals("We're sorry, the credentials you've provided are incorrect. Please try again",
